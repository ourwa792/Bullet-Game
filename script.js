...
const enemies = [
    ...
    new Enemy(350,20,'green',26),
    new Enemy(450,20,'gold',15),
    new Enemy(50,100,'green',5),
    new Enemy(150,100,'red',50),
    new Enemy(250,100,'gold',5),
    new Enemy(350,100,'green',3),
    new Enemy(450,100,'gold',47),
...
setCommonStyle();
 ...
 enemies.forEach((enemy)=>{
    ...
    {  if (enemy.health<= 0) {const index = enemies.indexOf(enemy)
